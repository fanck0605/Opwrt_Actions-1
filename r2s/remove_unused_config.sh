...
[ -f configs/config_h5 ]     && echo -e '\nCONFIG_KERNEL_BUILD_USER="Quintus Chu"\nCONFIG_GRUB_TITLE="OpenWrt on Nanopi devices compiled by Quintus"' >> configs/config_h5
[ -f configs/config_h3 ]     && echo -e '\nCONFIG_KERNEL_BUILD_USER="Quintus Chu"\nCONFIG_GRUB_TITLE="OpenWrt on Nanopi devices compiled by Quintus"' >> configs/config_h3
