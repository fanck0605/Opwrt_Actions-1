### Openwrt x86精简版：
1. 参考[P3TERX](https://github.com/P3TERX/Actions-OpenWrt)及[soffchen
](https://github.com/soffchen/NanoPi-R2S)的自动编译，使用 [Lean](https://github.com/coolsnowwolf/lede) 最新源码
